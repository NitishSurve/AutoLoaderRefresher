...
# MAGIC %run "/Workspace/Users/nitishsurve887@gmail.com/4. Common"
...
# MAGIC %sql
# MAGIC select distinct * from dev_catalog.bronze.raw_roads;

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from dev_catalog.bronze.raw_traffic;
# MAGIC
